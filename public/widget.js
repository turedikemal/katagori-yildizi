...
function injectRuntimeStyles(){
 if(!document.querySelector('link[data-ky-color-integrity]')){
   const l=document.createElement('link');l.rel='stylesheet';l.href=`${API_HOST}/template-color-integrity.css?v=20260917-6`;l.dataset.kyColorIntegrity='1';document.head.appendChild(l);
 }
 ...
 .ky-pos-bottom-full>.ky-offset-shell,.ky-pos-under-full>.ky-offset-shell{display:flex;width:100%;max-width:none;justify-content:center}
 .ky-pos-bottom-full .ky-badge-root,.ky-pos-under-full .ky-badge-root{width:100%;min-width:100%;max-width:none;justify-content:center;box-sizing:border-box}
 .ky-pos-bottom-full .ky-badge-root:not([class*="ky-tpl-premium-elite-"]),.ky-pos-under-full .ky-badge-root:not([class*="ky-tpl-premium-elite-"]){border-radius:0!important;transform:none!important}
...
function animationClasses(c){const a=c.animation||{};return `${a.entry&&a.entry!=='none'?'ky-anim-'+a.entry:''}`.trim();}
