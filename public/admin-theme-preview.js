...
function captureLiveSettings(canvas){
 ...
 if(pos){if(pos.classList.contains('pos-bottom-bar'))lastPlacement='under';else{const cls=[...pos.classList].find(x=>x.startsWith('pos-'));lastPlacement=cls?cls.replace('pos-',''):'top-left';}}
}
