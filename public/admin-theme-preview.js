...
function injectStyles(){
 ...
 .ky-focus-insidebar{position:absolute;z-index:3;left:0;right:0;bottom:0;min-height:34px;display:flex;align-items:center;justify-content:center;overflow:hidden}.ky-focus-insidebar .ky-v3-badge{width:100%!important;justify-content:center!important;border-radius:0!important;box-shadow:none!important;transform:none!important}.ky-focus-insidebar .ky-badge-text,.ky-focus-underbar .ky-badge-text{display:inline!important;visibility:visible!important;opacity:1!important;color:inherit!important}
...
function captureLiveSettings(canvas){
 ...
 const pos=canvas.querySelector('.ky-v3-badge-position');
 if(pos){if(pos.classList.contains('pos-bottom-bar'))lastPlacement='under';else if(pos.classList.contains('pos-bottom-inside'))lastPlacement='inside';else{const cls=[...pos.classList].find(x=>x.startsWith('pos-'));lastPlacement=cls?cls.replace('pos-',''):'top-left';}}
}
