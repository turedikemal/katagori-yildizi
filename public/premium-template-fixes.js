...
function loadGuard(){
 ...
 const s=document.createElement('script');s.src='/premium-preview-guard.js?v=20260916-4';s.async=false;s.dataset.kyPremiumPreviewGuard='1';document.body.appendChild(s);
}
