...
function loadGuard(){
 ...
 const s=document.createElement('script');s.src='/premium-preview-guard.js?v=20260917-2';s.async=false;s.dataset.kyPremiumPreviewGuard='1';document.body.appendChild(s);
}
